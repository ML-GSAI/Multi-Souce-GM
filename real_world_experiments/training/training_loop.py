...
def learning_rate_schedule(cur_nimg, batch_size, ref_lr=100e-4, ref_batches=70e3, rampup_Mimg=10):
    ...
    lr = ref_lr
    if ref_batches > 0:
        if cur_nimg / (ref_batches * batch_size) > 1:
            lr /= np.sqrt(cur_nimg * 4 / (ref_batches * batch_size))
...
if __name__ == '__main__':
    print(learning_rate_schedule(cur_nimg=136183812, batch_size=2048, ref_lr=0.004, ref_batches=3000, rampup_Mimg=10))