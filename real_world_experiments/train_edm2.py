...
import torch
import dnnlib
from loss_plot import draw_loss_curve
...
config_presets = {
    'edm2-img256-xs-1c-100':   dnnlib.EasyDict(duration=(2048<<14)+(2048<<13), batch=2048, channels=128, lr=0.0040, decay=4000, dropout=0.00, P_mean=-0.4, P_std=1.0),
    'edm2-img256-xs-1c-500':   dnnlib.EasyDict(duration=(2048<<16), batch=2048, channels=128, lr=0.0040, decay=2000, dropout=0.00, P_mean=-0.4, P_std=1.0),
    'edm2-img256-xs-1c-1000':   dnnlib.EasyDict(duration=(2048<<16)+(2048<<14)+(2048<<13), batch=2048, channels=128, lr=0.0050, decay=2500, dropout=0.00, P_mean=-0.4, P_std=1.0),
    'edm2-img256-xs-3c-100':   dnnlib.EasyDict(duration=(2048<<15), batch=2048, channels=128, lr=0.0020, decay=2000, dropout=0.00, P_mean=-0.4, P_std=1.0),
    'edm2-img256-xs-3c-500':   dnnlib.EasyDict(duration=(2048<<15), batch=2048, channels=128, lr=0.0020, decay=2500, dropout=0.00, P_mean=-0.4, P_std=1.0),
    'edm2-img256-xs-3c-1000':   dnnlib.EasyDict(duration=(2048<<15), batch=2048, channels=128, lr=0.0020, decay=2500, dropout=0.00, P_mean=-0.4, P_std=1.0),
    'edm2-img256-xs-5c-100':   dnnlib.EasyDict(duration=(2048<<15), batch=2048, channels=128, lr=0.0040, decay=4000, dropout=0.00, P_mean=-0.4, P_std=1.0),
    'edm2-img256-xs-5c-500':   dnnlib.EasyDict(duration=(2048<<15)+(2048<<15), batch=2048, channels=128, lr=0.0060, decay=4000, dropout=0.00, P_mean=-0.4, P_std=1.0),
    'edm2-img256-xs-5c-1000':   dnnlib.EasyDict(duration=(2048<<15)+(2048<<14), batch=2048, channels=128, lr=0.0060, decay=4000, dropout=0.00, P_mean=-0.4, P_std=1.0),
    'edm2-img256-xs-10c-100':   dnnlib.EasyDict(duration=(2048<<15), batch=2048, channels=128, lr=0.0030, decay=3000, dropout=0.00, P_mean=-0.4, P_std=1.0),
    'edm2-img256-xs-10c-500':   dnnlib.EasyDict(duration=(2048<<15)+(2048<<14), batch=2048, channels=128, lr=0.0030, decay=3000, dropout=0.00, P_mean=-0.4, P_std=1.0),
    'edm2-img256-xs-10c-1000':   dnnlib.EasyDict(duration=(3072<<17), batch=2048, channels=128, lr=0.0060, decay=3000, dropout=0.00, P_mean=-0.4, P_std=1.0),
    'edm2-img256-xs-10c-1000-nlr':   dnnlib.EasyDict(duration=(2048<<19)+(2048<<18), batch=2048, channels=128, lr=0.0040, decay=6000, dropout=0.00, P_mean=-0.4, P_std=1.0),
}
